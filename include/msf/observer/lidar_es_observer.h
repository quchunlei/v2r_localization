...
#ifndef LIDAR_ES_OBSERVER_H
#define LIDAR_ES_OBSERVER_H
...
namespace msf
{
class LidarEsObserver : public Observer
{
public:
  LidarEsObserver() = delete;
  LidarEsObserver(const std::string name, const YAML::Node& param, const std::shared_ptr<SensorFusion> sensor_fusion,
