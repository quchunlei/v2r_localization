 ...
 *
 */
#ifndef RS_LOCALIZATION_ODOM_OBSERVER_H
#define RS_LOCALIZATION_ODOM_OBSERVER_H
...
namespace msf
{
class OdomObserver : public Observer
{
public:
  OdomObserver() = delete;
  OdomObserver(const std::string name, const YAML::Node& param, const std::shared_ptr<SensorFusion> sensor_fusion);
  ~OdomObserver();
...
#endif /* RS_LOCALIZATION_ODOM_OBSERVER_H */
