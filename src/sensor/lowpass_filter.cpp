#include "sensor/lowpass_filter.h"

LowPassFilter::LowPassFilter() : output(0), cutOffFrequency(0)
{
}

LowPassFilter::LowPassFilter(float iCutOffFrequency) : output(0), cutOffFrequency(iCutOffFrequency), ePow(0)
{
}

LowPassFilter::LowPassFilter(float iCutOffFrequency, float iDeltaTime)
  : output(0), cutOffFrequency(iCutOffFrequency), ePow(1 - exp(-iDeltaTime * iCutOffFrequency))
{
}
